<?php
session_start();
include '../model/get_services_plombier.php'; 
?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-10 text-center md:text-left">
            <h1 class="text-3xl font-extrabold text-gray-900 flex items-center justify-center md:justify-start">
                <i class="fas fa-faucet text-orange-500 mr-3"></i> Artisans en Plomberie
            </h1>
            <p class="text-gray-500 mt-2">
                <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm font-bold">
                    <?php echo count($services); ?> plombiers disponibles
                </span>
            </p>
        </div>
        ...
        <?php else: ?>
            <div class="bg-white rounded-3xl p-20 text-center shadow-sm border border-gray-100">
                <div class="text-gray-200 mb-4">
                    <i class="fas fa-faucet text-6xl"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-800">Aucun plombier trouvé</h3>
                <p class="text-gray-500">Soyez le premier plombier à proposer vos services ici !</p>

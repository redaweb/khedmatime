...
<section class="py-12 container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="relative group overflow-hidden rounded-2xl shadow-md h-64 cursor-pointer">
            <img src="https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&q=80&w=600" class="w-full h-full object-cover transition duration-500 group-hover:scale-110">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex flex-col justify-end p-6">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Choisissez une date et une heure qui vous conviennent directement depuis la plateforme.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Notre professionnel arrive chez vous et s'occupe de tout. Satisfaction garantie.</p>
                        </div>
                    </div>
                </div>
            </div>

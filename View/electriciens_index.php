<?php
session_start();
include '../model/get_services_electricite.php'; 
?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-10 text-center md:text-left">
            <h1 class="text-3xl font-extrabold text-gray-900 flex items-center justify-center md:justify-start">
                <i class="fas fa-bolt text-orange-500 mr-3"></i> Artisans en Électricité
            </h1>
            <p class="text-gray-500 mt-2">
                <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm font-bold">
                    <?php echo count($services); ?> électriciens qualifiés
                </span>
            </p>
        </div>
        ...
        <?php else: ?>
            <div class="bg-white rounded-3xl p-20 text-center shadow-sm border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-800">Aucun électricien trouvé</h3>
                <p class="text-gray-500">Soyez le premier à proposer vos services électriques !</p>

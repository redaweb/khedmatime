<?php
session_start();
include '../model/get_services_menuiserie.php'; 
?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-10 text-center md:text-left">
            <h1 class="text-3xl font-extrabold text-gray-900 flex items-center justify-center md:justify-start">
                <i class="fas fa-hammer text-orange-500 mr-3"></i> Artisans en Menuiserie
            </h1>
        ...
        <?php else: ?>
            <div class="bg-white rounded-3xl p-20 text-center shadow-sm border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-800">Aucun artisan trouvé</h3>
                <p class="text-gray-500">Soyez le premier artisan menuisier de votre région !</p>
                <a href="service.php" class="mt-6 inline-block bg-orange-500 text-white px-8 py-3 rounded-full font-bold">S'inscrire comme artisan</a>
            </div>
        <?php endif; ?>
    </div>

<?php
session_start();
include '../model/get_service_mecanique.php'; 
?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-10 text-center md:text-left">
            <h1 class="text-3xl font-extrabold text-gray-900 flex items-center justify-center md:justify-start">
                <i class="fas fa-car-side text-orange-500 mr-3"></i> Artisans en Mécanique
            </h1>
            <p class="text-gray-500 mt-2">
                <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm font-bold">
                    <?php echo count($services); ?> garagistes & mécaniciens
                </span>
            </p>
        </div>
        ...
        <?php else: ?>
            <div class="bg-white rounded-3xl p-20 text-center shadow-sm border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-800">Aucun mécanicien trouvé</h3>
                <p class="text-gray-500">Un problème moteur ? Revenez vérifier d'ici peu !</p>
                <a href="service.php" class="mt-6 inline-block bg-orange-500 text-white px-8 py-3 rounded-full font-bold transition hover:bg-orange-600">Proposer mes services</a>
            </div>
        <?php endif; ?>
    </div>
